 ...
 * transform() is called with the new value and the returned value will be the
 * signal's new value, so be sure to always return something.
 *
 * @param newValue
 * @returns {*}
 */
 ...
 * and the old as second and the calling signal as third.
 *
...
Signal.prototype._write = function (newValue) {
    ...
    if (isPrimitive(newValue) && newValue === oldValue) {
        return;
    }
