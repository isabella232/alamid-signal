 ...
 * the old value the signal will not trigger. Otherwise it will always trigger if
 * the signal is called with a new value.
 *
 * @returns {Function}
...
function Signal(value) {
    function signal(newValue) {
        ...
        trigger(signal._listeners, newValue, oldValue, signal);
